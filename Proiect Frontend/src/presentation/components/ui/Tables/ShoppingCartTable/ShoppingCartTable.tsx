...
import { useShoppingCartTableController } from "./ShoppingCartTable.controller";
...
export const ShoppingCartTable = () => {
    ...
    const { handleChangePage, handleChangePageSize, pagedData, isError, isLoading, tryReload, labelDisplay, search, setSearchQuery, remove} = useShoppingCartTableController(); // Use the controller hook.
