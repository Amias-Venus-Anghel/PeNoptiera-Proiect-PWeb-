 ...
 */
export const useShoppingCartTableController = () => {
    const { getProducts: { key: queryKey, query },  deleteProduct: { key: deleteProductKey, mutation: deleteProduct } } = useShoppingCartApi();
