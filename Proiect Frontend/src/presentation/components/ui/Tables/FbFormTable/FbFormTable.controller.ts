 ...
 */
export const useFbFormTableController = () => {
    const { getFbForms: { key: queryKey, query }, deleteFbForm: { key: deleteFbFormKey, mutation: deleteFbForm } } = useFbFormApi(); // Use the API hook.
    ...
    const { mutateAsync: deleteMutation } = useMutation({
        mutationKey: [deleteFbFormKey],
        mutationFn: deleteFbForm
