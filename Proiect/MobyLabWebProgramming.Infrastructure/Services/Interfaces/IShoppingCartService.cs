...
public interface IShoppingCartService
{
    ...
    public Task<ServiceResponse<PagedResponse<ProductDTO>>> GetProductsInCartOfUser(PaginationSearchQueryParams pagination, UserDTO requestingUser, CancellationToken cancellationToken = default);
}
